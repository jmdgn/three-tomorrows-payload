          ...
          if (authorObj.authorProfile.isAuthor) {
            ...
            if (authorObj.authorProfile.photo) {
              if (typeof authorObj.authorProfile.photo === 'string') {
                ...
                typeof authorObj.authorProfile.photo === 'object' &&
                authorObj.authorProfile.photo.url
              ) {
              ...
              <div className="articleTitle-container">
                {categories && Array.isArray(categories) && categories.length > 0 ? (
                  ...
                  post.categories.some(
                    (cat) => typeof cat === 'object' && cat && (cat.title || cat.name),
                  ) ? (
                  <div className="categoryText">
                    <p>
                      {post.categories
                ...
                <div className="shareButton-frame">
                  ...
                  <div className="share-buttons" id="article-share">
                    <div className="shareButton-row">
                      <a
                        href={`mailto:?subject=${encodeURIComponent(post.title)}&body=${encodeURIComponent(`I thought you might find this interesting: ${typeof window !== 'undefined' ? window.location.href : ''}`)}`}
                  ...
                  <div className="related-posts-grid">
                    {post.relatedPosts.map((relatedPost, index) => {
                      if (typeof relatedPost === 'object' && relatedPost && relatedPost.title) {
                        const relatedImageData =
                          relatedPost.meta && relatedPost.meta.image
                            ? {
                                url:
                                  typeof relatedPost.meta.image.url === 'string'
                                    ? relatedPost.meta.image.url
                                    : null,
                                alt:
                                  typeof relatedPost.meta.image.alt === 'string'
                                    ? relatedPost.meta.image.alt
                                    : relatedPost.title || 'Related post image',
                              }
                            : null
